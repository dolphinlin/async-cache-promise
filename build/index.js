...
var AsyncCache = /** @class */ (function () {
    function AsyncCache(opt) {
        var _a = opt || {}, load = _a.load, lruOpt = __rest(_a, ["load"]);
        this.cache = new LRU__default['default'](lruOpt);
    ...
    AsyncCache.prototype.get = function (key) {
        ...
        return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            var pending, hasValue, cached, res_1, err_1;
            var _a, _b;
                ...
                switch (_c.label) {
                    case 0:
                        ...
                        if (this.pending.has(key)) {
                            return [2 /*return*/, this.pending.set(key, pending)];
                        }
                    ...
                    case 2:
                        res_1 = _c.sent();
                        this.cache.set(key, res_1);
                        // get new pending
                        (_a = this.pending.get(key)) === null || _a === void 0 ? void 0 : _a.forEach(function (_a) {
                            var cb = _a[0];
                            return cb(res_1);
                        });
                        return [3 /*break*/, 5];
                    case 3:
                        err_1 = _c.sent();
                        // get new pending
                        (_b = this.pending.get(key)) === null || _b === void 0 ? void 0 : _b.forEach(function (_a) {
                            var cb = _a[1];
                            return cb(err_1);
                        });
                        return [3 /*break*/, 5];
